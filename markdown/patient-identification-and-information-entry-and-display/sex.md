---
title: "Document Properties Document Title Sex and Current Gender Input and Display"
---
...
- [2 RECOMMENDATIONS AND GUIDANCE](#2-recommendations-and-guidance)
  - [2.1 Current Gender Values](#21-current-gender-values)
    - [2.1.1 Guidance](#211-guidance)
    - [2.1.2 Examples of Correct Usage](#212-examples-of-correct-usage)
  - [ Alphabetic string Male](#alphabetic-string-male)
    - [2.1.3 Examples of Incorrect Usage](#213-examples-of-incorrect-usage)
  - [ Numeric code 0](#numeric-code-0)
  - [ Numeric code and text 0 Not Known](#numeric-code-and-text-0-not-known)
    - [2.1.4 Rationale](#214-rationale)
  - [2.2 Sex Values](#22-sex-values)
  ...
  - [ Numeric code 1](#numeric-code-1)
  - [ Numeric code and text 1 Male](#numeric-code-and-text-1-male)
    - [2.2.4 Rationale](#224-rationale)
  - [2.3 Instructional Text](#23-instructional-text)
    - [2.3.1 Current Gender Instructional Text](#231-current-gender-instructional-text)
    - [2.3.2  Sex Instructional Text](#232-sex-instructional-text)
    - [2.3.3 Data Values Instructional Text](#233-data-values-instructional-text)
    - [2.3.4 Guidance](#234-guidance)
    - [2.3.5 Examples of Correct Usage](#235-examples-of-correct-usage)
  - [ Alphabetic](#alphabetic)
    - [2.3.6 Rationale](#236-rationale)
  - [2.4 Control Layout and Structure](#24-control-layout-and-structure)
    - [2.4.1 Current Gender Option Button Group](#241-current-gender-option-button-group)
  - [ Five option](#five-option)
  - [ ‘Not Known’ is](#not-known-is)
  - [ Incorrect](#incorrect)
  - [ Incorrect input](#incorrect-input)
  - [ Incorrect value](#incorrect-value)
  - [ Too few options](#too-few-options)
  - [ Too many](#too-many)
  - [ Incorrect control](#incorrect-control)
    - [2.4.2 Sex Option Button Group](#242-sex-option-button-group)
  - [ Four option](#four-option)
  - [ ‘Null’ default state](#null-default-state)
    - [2.4.3 Current Gender Drop-Down List Box](#243-current-gender-drop-down-list-box)
  - [ Drop-down list](#drop-down-list)
  - [ Incorrect default](#incorrect-default)
    - [2.4.4 Sex Drop-Down List Box](#244-sex-drop-down-list-box)
  - [ Four item](#four-item)
  - [ ‘Null’ default state Default state should be null, which will](#null-default-state-default-state-should-be-null-which-will)
...
Source PDF: [sex.pdf](../../pdfs/patient-identification-and-information-entry-and-display/sex.pdf)
...
The Current Gender input controls are used to record the gender, according to how a patient currently describes themselves, whereas the Sex input controls records their _phenotypic_ sex (see section 2.4 for more information).
