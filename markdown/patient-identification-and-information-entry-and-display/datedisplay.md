...
- [1 INTRODUCTION](#1-introduction)
  - [1.1 Table 1: Changes Since the Last Baseline VersionCustomer Need](#11-table-1-changes-since-the-last-baseline-versioncustomer-need)
  - [1.2 Scope](#12-scope)
...
Source PDF: [datedisplay.pdf](../../pdfs/patient-identification-and-information-entry-and-display/datedisplay.pdf)
...
“ _Visitors to a web site from varying locales may be confused by date formats. The format_ _MM/DD/YY is unique to the United States. Most of Europe uses DD/MM/YY. Japan uses_ _YY/MM/DD. The separators may be slashes, dashes or periods. Some locales print leading zeroes,_ _others suppress them. If a native Japanese speaker is reading a US English web page from a web_ _site in Germany that contains the date 03/04/02 how do they interpret it?”_ **{R3}**
...
described in _Design Guide Entry – Time Display_ **{R5}**, and entering time is described in _Design Guide Entry – Date and Time Input_ **{R4}**
