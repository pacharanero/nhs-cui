---
title: "Sex and Current Gender Input and Display"
---
...
- [Sex and Current Gender Input and Display](#sex-and-current-gender-input-and-display)
  - [Quick Implementation Guide](#quick-implementation-guide)
    - [Edition 1 22 [nd] April 2010](#edition-1-22-nd-april-2010)
      ...
      - [2](#2)
      - [Guidance](#guidance)
    - [Current Gender and Sex Display](#current-gender-and-sex-display)
      - [The Current Gender status is one of the illustrated values](#the-current-gender-status-is-one-of-the-illustrated-values)
      - [The Sex status must only contain one of the illustrated values](#the-sex-status-must-only-contain-one-of-the-illustrated-values)
      - [Label the Current Gender status display ‘Current Gender’](#label-the-current-gender-status-display-current-gender)
      - [3](#3)
      - [Label the Sex status display ‘Sex’](#label-the-sex-status-display-sex)
    - [Current Gender and Sex Input](#current-gender-and-sex-input)
      - [4](#4)
    - [Current Gender Input](#current-gender-input)
      - [Label the Current Gender input controls ‘Current Gender’](#label-the-current-gender-input-controls-current-gender)
      - [Use ‘Not Known’ as the Current Gender default value](#use-not-known-as-the-current-gender-default-value)
      - [Current Gender option buttons group input controls must consist of five option buttons](#current-gender-option-buttons-group-input-controls-must-consist-of-five-option-buttons)
      - [Current Gender option button group labels must be in the order illustrated](#current-gender-option-button-group-labels-must-be-in-the-order-illustrated)
      - [The Current Gender tab order is the same as illustrated](#the-current-gender-tab-order-is-the-same-as-illustrated)
      - [5](#5)
      - [Use a single drop-down list box for the Current Gender control](#use-a-single-drop-down-list-box-for-the-current-gender-control)
      - [Current Gender drop-down list box options are in the order illustrated](#current-gender-drop-down-list-box-options-are-in-the-order-illustrated)
      - [Do not use a prompt for the Current Gender control, due to its default value of ‘Not Known’](#do-not-use-a-prompt-for-the-current-gender-control-due-to-its-default-value-of-not-known)
      - [Make the definitions of the Current Gender status values accessible to the user](#make-the-definitions-of-the-current-gender-status-values-accessible-to-the-user)
      - [6](#6)
      - [7](#7)
      - [The Current Gender values are as illustrated](#the-current-gender-values-are-as-illustrated)
      - [Do not abbreviate Current Gender data values](#do-not-abbreviate-current-gender-data-values)
      - [Do not display the underlying coded representation of the Current Gender data values For example, the standard code for ‘Male’ may be the integer 1, but this number should not appear](#do-not-display-the-underlying-coded-representation-of-the-current-gender-data-values-for-example-the-standard-code-for-male-may-be-the-integer-1-but-this-number-should-not-appear)
    - [Sex Input](#sex-input)
      - [Label the Sex input controls ‘Sex’](#label-the-sex-input-controls-sex)
      - [The Sex default state is null](#the-sex-default-state-is-null)
      - [Sex option button group input controls must consist of four option buttons](#sex-option-button-group-input-controls-must-consist-of-four-option-buttons)
      - [Sex option button group labels are in the order illustrated](#sex-option-button-group-labels-are-in-the-order-illustrated)
      - [8](#8)
      - [9](#9)
      - [Ensure that Sex controls have no value selected by default and no method of returning to this ‘null’ state](#ensure-that-sex-controls-have-no-value-selected-by-default-and-no-method-of-returning-to-this-null-state)
      - [Use a single control for the Sex drop-down list box](#use-a-single-control-for-the-sex-drop-down-list-box)
      - [Ensure that the Sex drop-down list box is blank by default and does not contain a prompt](#ensure-that-the-sex-drop-down-list-box-is-blank-by-default-and-does-not-contain-a-prompt)
      - [Make the definitions of the Sex status values accessible to the user](#make-the-definitions-of-the-sex-status-values-accessible-to-the-user)
      - [The Sex values are as illustrated](#the-sex-values-are-as-illustrated)
      - [Sex data values must never be abbreviated](#sex-data-values-must-never-be-abbreviated)
      - [The application must not display the underlying coded representation of the Sex data values For example, the standard code for ‘Male’ may be the integer 1, but this number must not appear](#the-application-must-not-display-the-underlying-coded-representation-of-the-sex-data-values-for-example-the-standard-code-for-male-may-be-the-integer-1-but-this-number-must-not-appear)
      - [10](#10)
    - [Input Control Definitions](#input-control-definitions)
      - [11](#11)
      - [Provide definitions for input controls](#provide-definitions-for-input-controls)
      - [Provide a shortened version of the definitions](#provide-a-shortened-version-of-the-definitions)
      - [Provide access to definitions of the valid values](#provide-access-to-definitions-of-the-valid-values)
      - [12](#12)

<!-- /TOC -->

Source PDF: [sexqig.pdf](../../pdfs/patient-identification-and-information-entry-and-display/sexqig.pdf)
...
The values defined in this document are based upon the current proposed changes to the _NHS Data Model and Dictionary_ **[1]** . Should future changes be made to this document, amendments to this guidance will be required.

Although it contains all of the guidance points, this document omits supporting information and is therefore not intended as a substitute for the full NHS CUI document _Sex and Current Gender Input and Display_ **[2]** . Refer to that document for the definitive statement of the design guidance in this area.
...
CGS-0007 _Current Gender_ Not Known
