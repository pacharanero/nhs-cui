...
- [2 SEARCH AND PRESCRIBE GUIDANCE OVERVIEW](#2-search-and-prescribe-guidance-overview)
  - [2.1 Rationale Summary](#21-rationale-summary)
  - [2.2 Summary of Guidance](#22-summary-of-guidance)
- [3 GUIDANCE DETAILS FOR A PRESCRIBING AREA](#3-guidance-details-for-a-prescribing-area)
  - [3.1 Introduction](#31-introduction)
  - [3.2 Principles](#32-principles)
  - [3.3 Guidelines](#33-guidelines)
    - [3.3.1 Relating Prescribing to Context](#331-relating-prescribing-to-context)
- [4 GUIDANCE DETAILS FOR QUICK LISTS](#4-guidance-details-for-quick-lists)
  - [4.1 Introduction](#41-introduction)
  - [4.2 Principles](#42-principles)
  - [4.3 Guidelines](#43-guidelines)
    - [4.3.1 Displaying a Quick List](#431-displaying-a-quick-list)
    - [4.3.2 Quick List Contents](#432-quick-list-contents)
    - [4.3.3 Notifying When a Quick List Has Changed](#433-notifying-when-a-quick-list-has-changed)
    - [4.3.4 Accommodating Multiple Quick Lists](#434-accommodating-multiple-quick-lists)
- [5 GUIDANCE DETAILS FOR DRUG SEARCH](#5-guidance-details-for-drug-search)
  - [5.1 Introduction](#51-introduction)
  - [5.2 Principles](#52-principles)
  - [5.3 Guidelines](#53-guidelines)
    - [5.3.1 Positioning the Search Text Input Box](#531-positioning-the-search-text-input-box)
    - [5.3.2 Defining Text Input Box Behaviour](#532-defining-text-input-box-behaviour)
    - [5.3.3 Displaying Results with Progressive Matching](#533-displaying-results-with-progressive-matching)
    - [5.3.4 Providing Feedback for a Progressive Search](#534-providing-feedback-for-a-progressive-search)
    - [5.3.5 Limiting the Height of a Search Results List](#535-limiting-the-height-of-a-search-results-list)
    - [5.3.6 Extending the Search Results List](#536-extending-the-search-results-list)
    - [5.3.7 Matching Input Text to Results](#537-matching-input-text-to-results)
    - [5.3.8 Ordering Search Results](#538-ordering-search-results)
    - [5.3.9 Using Groups to Limit Search Results](#539-using-groups-to-limit-search-results)
    - [5.3.10 Supporting Spelling Matches and Synonyms](#5310-supporting-spelling-matches-and-synonyms)
    - [5.3.11 Co-Drugs and Their Ingredients](#5311-co-drugs-and-their-ingredients)
    - [5.3.12 Prioritising Results](#5312-prioritising-results)
    - [5.3.13 Shortcut Keys in Search Results](#5313-shortcut-keys-in-search-results)
    - [5.3.14 Formatting Commonly Mis-Selected Matches](#5314-formatting-commonly-mis-selected-matches)
    - [5.3.15 Formatting Spelling Matches and Synonyms](#5315-formatting-spelling-matches-and-synonyms)
    - [5.3.16 Formatting Search Results Lists](#5316-formatting-search-results-lists)
    - [5.3.17 Generic Drug Names and Brand Names](#5317-generic-drug-names-and-brand-names)
- [6 GUIDANCE DETAILS FOR CASCADING LISTS](#6-guidance-details-for-cascading-lists)
  - [6.1 Introduction](#61-introduction)
  - [6.2 Principles](#62-principles)
  - [6.3 Guidelines](#63-guidelines)
    - [6.3.1 Providing Cascading Lists](#631-providing-cascading-lists)
    - [6.3.2 Displaying Cascading Lists](#632-displaying-cascading-lists)
    - [6.3.3 Contents of Cascading Lists](#633-contents-of-cascading-lists)
    - [6.3.4 Providing Cascading Lists for Brands](#634-providing-cascading-lists-for-brands)
- [7 GUIDANCE DETAILS FOR REQUIRED ATTRIBUTES](#7-guidance-details-for-required-attributes)
  - [7.1 Introduction](#71-introduction)
  - [7.2 Principles](#72-principles)
  - [7.3  Guidelines](#73-guidelines)
    - [7.3.1 Displaying Template Prescriptions](#731-displaying-template-prescriptions)
    - [7.3.2 Displaying a Selection Trail](#732-displaying-a-selection-trail)
    - [7.3.3 Template Prescription Layout](#733-template-prescription-layout)
    - [7.3.4 Contents of a Template Prescription](#734-contents-of-a-template-prescription)
    - [7.3.5 Maintaining Access to Template Prescriptions](#735-maintaining-access-to-template-prescriptions)
    - [7.3.6 Presenting Fields Step by Step](#736-presenting-fields-step-by-step)
    - [7.3.7 Using Sentence Layout](#737-using-sentence-layout)
- [8 GUIDANCE DETAILS FOR PRESCRIPTION FORMS](#8-guidance-details-for-prescription-forms)
  - [8.1 Introduction](#81-introduction)
  - [8.2 Principles](#82-principles)
  - [8.3 Guidelines](#83-guidelines)
    - [8.3.1 Presentation and Layout of Prescription forms](#831-presentation-and-layout-of-prescription-forms)
    - [8.3.2 Presenting a Detailed Prescription Form](#832-presenting-a-detailed-prescription-form)
    - [8.3.3 Structuring a Detailed Prescription](#833-structuring-a-detailed-prescription)
    - [8.3.4 Displaying Required and Optional Fields](#834-displaying-required-and-optional-fields)
- [9 GUIDANCE DETAILS FOR INPUT CONTROLS](#9-guidance-details-for-input-controls)
  - [9.1 Introduction](#91-introduction)
  - [9.2 Principles](#92-principles)
  - [9.3 Guidelines](#93-guidelines)
    - [9.3.1 Using Dynamic Controls](#931-using-dynamic-controls)
    - [9.3.2 Presenting Selection Lists in Prescription forms](#932-presenting-selection-lists-in-prescription-forms)
    - [9.3.3 Using Selection Lists to Prioritise](#933-using-selection-lists-to-prioritise)
    - [9.3.4 Presenting Selection Lists for Inter-Related Fields](#934-presenting-selection-lists-for-inter-related-fields)
    - [9.3.5 Pre-Filling Input Controls](#935-pre-filling-input-controls)
    - [9.3.6 Presenting Input Controls](#936-presenting-input-controls)
- [10 GUIDANCE DETAILS FOR PREVIEW AND AUTHORISE](#10-guidance-details-for-preview-and-authorise)
  - [10.1 Introduction](#101-introduction)
  - [10.2 Principles](#102-principles)
  - [10.3 Guidelines](#103-guidelines)
    - [10.3.1 Providing a Preview](#1031-providing-a-preview)
    - [10.3.2 Presenting Controls for Authorising a Prescription](#1032-presenting-controls-for-authorising-a-prescription)
...
- [APPENDIX A USABILITY PRINCIPLES](#appendix-a-usability-principles)
  ...
  - [A.3 ISO 9241: Presentation of Information](#a3-iso-9241-presentation-of-information)
- [APPENDIX B STUDY ID 69: EXECUTIVE SUMMARY](#appendix-b-study-id-69-executive-summary)
...
- [APPENDIX C STUDY ID 68: EXECUTIVE SUMMARY](#appendix-c-study-id-68-executive-summary)
  ...
  - [C.4 Results](#c4-results)
    - [C.4.1 Participant Description](#c41-participant-description)
    - [C.4.2 Hazards](#c42-hazards)
- [APPENDIX D STUDY ID 67: EXECUTIVE SUMMARY](#appendix-d-study-id-67-executive-summary)
  - [D.1 Abstract](#d1-abstract)
  - [D.2 Research Objectives](#d2-research-objectives)
  - [D.3 Research Design](#d3-research-design)
  - [D.4 Results](#d4-results)
    - [D.4.1 Participant Description](#d41-participant-description)
    - [D.4.2 Design Areas](#d42-design-areas)
- [APPENDIX E STUDY ID 46: EXECUTIVE SUMMARY](#appendix-e-study-id-46-executive-summary)
  - [E.1 Abstract](#e1-abstract)
  - [E.2 Research Objectives](#e2-research-objectives)
  - [E.3 Research Design](#e3-research-design)
  - [E.4 Results](#e4-results)
    - [E.4.1 Participant Description](#e41-participant-description)
    - [E.4.2 Design Areas](#e42-design-areas)
- [APPENDIX F STUDY ID 37: EXECUTIVE SUMMARY](#appendix-f-study-id-37-executive-summary)
  - [F.1 Abstract](#f1-abstract)
  - [F.2 Research Objectives](#f2-research-objectives)
  - [F.3 Research Design](#f3-research-design)
  - [F.4 Results](#f4-results)
    - [F.4.1 Participant Description](#f41-participant-description)
    - [F.4.2 Design Areas](#f42-design-areas)
...
Source PDF: [searchpres.pdf](../../pdfs/medications-management/searchpres.pdf)
...
Electronic prescribing is envisaged as being part of a clinical system that includes a series of views, some of which present medications information for each patient. Guidance for the display of a patient’s medications is defined in the document _Medications Management –_ _Medications List_ **{R1}** . Guidance for another medications view, the drug chart, is defined in the document _Medications_ _Management –_ _Drug Administration_ **{R2}** .

More detailed guidance for the layout and formatting of individual medications is defined in the document _Medications Management –_ _Medication Line_ **{R3}** . This includes guidance that informs the selection of attributes and defines display formatting appropriate for the information used to express a single medication. (Later, this approach is referred to simply as ‘medication line’.)

The structure of the prescribing processes considered in the creation of this guidance has been informed by the NHS National Programme for Information Technology (NPfIT) document _dm+d_ _Implementation Guide (Secondary Care)_ _[2]_. This work describes a Prescribing Model that is designed to minimise the risk when prescribing (or ‘ordering’) medications in secondary care. It advocates a dose-based prescribing system in which:
...
2 NHS NPfIT – dm+d Implementation Guide (Secondary Care) **{R4}** : [ePrescribing reference documents — NHS Connecting for Health](http://www.connectingforhealth.nhs.uk/systemsandservices/eprescribing/refdocs)

3 NHS – dictionary of medicines + devices **{R5}** : [Welcome to the dm+d website — The NHS Dictionary of Medicines and](http://www.dmd.nhs.uk/) [Devices](http://www.dmd.nhs.uk/)
...
These findings are published in the document _Safety in doses: medication safety incidents in the_ _NHS_ _[4]_. In summary, the document lists the following as the most common types of reported medication incidents, which together make up over half of all reported medication incidents:
...
**The Role of Electronic Prescribing**  - Research, in which extensive studies of medication-related errors were reviewed, suggests that the most powerful means of preventing medication-related errors are electronic prescribing and administration management, along with standards for processes and for the writing of prescriptions (see _Medication Errors_ **{R7}**, _To Err Is Human_ **{R8}** and _Understanding Patient Safety_ **{R9}** ).
...
Whilst electronic prescribing is effective at mitigating some of the risks associated with paper-based prescribing, and is generally found to reduce prescribing errors overall, it also has the potential to introduce new kinds of errors (see _The Extent and Importance of Unintended Consequences_ _Related to Computerized Provider Order Entry_ **{R10}** ). Many of these errors are common to any human-computer interface and can be effectively mitigated by following current best practice usability principles.

The process of replacing a paper-based system with an electronic one inevitably also brings culture changes and changes to processes. Electronic systems that are perceived as being too restrictive are associated with loss of responsibility leading to complacency and over-reliance on the system. Inflexible prescribing systems may be effective at supporting the prescribing of common medications and the prevention of specific errors but the same inflexibility that supports these processes also introduces problems for prescribing non-standard medications (see _Role of_ _Computerised Physician Order Entry Systems in Facilitating Medication Errors_ **{R11}** ).
...
4NPSA – Safety in doses: medication safety incidents in the NHS **{R6}** : [http://www.npsa.nhs.uk/nrls/alerts-and-directives/directives-guidance/safety-in-doses/](http://www.npsa.nhs.uk/nrls/alerts-and-directives/directives-guidance/safety-in-doses/)
...
8 ISMP – ISMP MedicationSafetyAlert! – It’s Time for Standards to Improve Safety with Electronic Communication of Medication Orders – Draft Guidelines for Safe Electronic Communication of Medication Orders **{R21}** : [http://www.ismp.org/Newsletters/acutecare/articles/20030220.asp](http://www.ismp.org/Newsletters/acutecare/articles/20030220.asp)
...
9 The Joint Commission – National Patient Safety Goals – NPSG.03.03.01 – Look-alike/sound-alike drugs **{R23}** : [http://www.jointcommission.org/AccreditationPrograms/BehavioralHealthCare/Standards/09_FAQs/NPSG/Medication_safet](http://www.jointcommission.org/AccreditationPrograms/BehavioralHealthCare/Standards/09_FAQs/NPSG/Medication_safety/NPSG.03.03.01/look_alike_sound_alike_drugs.htm) [y/NPSG.03.03.01/look_alike_sound_alike_drugs.htm](http://www.jointcommission.org/AccreditationPrograms/BehavioralHealthCare/Standards/09_FAQs/NPSG/Medication_safety/NPSG.03.03.01/look_alike_sound_alike_drugs.htm)
...
The _ePrescribing Functional Specification_ **{R12}** includes a requirement (GEN.OS.082) in which it is stated that lists of favourite drugs should not be produced by individual users without their contents being reviewed and potentially updated centrally. Guidance for the Quick List (MSP-0060) reflects this principle of maintaining central control.
...
10 The Use of Tall Man Lettering to Minimise Selection Errors of Medicine Names in Computer Prescribing and Dispensing Systems **{R24}** [: http://www.ccforpatientsafety.org/patient-safety-solutions/](http://www.ccforpatientsafety.org/patient-safety-solutions/)
...
12 Microsoft – Windows User Experience Interaction Guidelines – Guidelines, Controls, Command Buttons **{R26}** : [http://msdn.microsoft.com/en-us/library/aa511453.aspx#defaults](http://msdn.microsoft.com/en-us/library/aa511453.aspx#defaults)
...
The _ePrescribing Functional Specification_ **{R12}** includes a guideline (GEN.OS.40) that refers to the need to be able to search by brand name and a guideline (GEN.DR.003) that refers to the need for a generic name to be included when a brand name is displayed.
...
14 NHS NPSA – The fourth report from the Patient Safety Observatory – PSO/4 – Safety in doses: medication safety incidents in the NHS **{R6}** [: http://www.nrls.npsa.nhs.uk/favicon.ico](http://www.nrls.npsa.nhs.uk/favicon.ico)

15The Joint Commission International – WHO Collaborating Centre for Patient Safety Releases Nine Life-Saving Patient Safety Solutions **{R29}** [: http://www.ccforpatientsafety.org/patient-safety-solutions/](http://www.ccforpatientsafety.org/patient-safety-solutions/)
...
The _ePrescribing Functional Specification_ **{R12}** includes a requirement (GEN.OS.94) to specifically address the risk of mis-selection when drugs that are known to be mis-selected are displayed in selection lists.
...
16 US Federal Drug Administration (FDA) Center for Drug Evaluation and Research (CDER) – Name Differentiation Project **{R30}** [: http://www.fda.gov/Drugs/DrugSafety/MedicationErrors/ucm164587.htm](http://www.fda.gov/Drugs/DrugSafety/MedicationErrors/ucm164587.htm)
...
17 NHS ePrescribing: Guidelines for hazard review of ePrescribing systems **{R31}** : [http://www.connectingforhealth.nhs.uk/systemsandservices/eprescribing/hazard_framework.pdf](http://www.connectingforhealth.nhs.uk/systemsandservices/eprescribing/hazard_framework.pdf)
...
18 Penzo, M – Label Placement in Forms **{R40}** : [http://www.uxmatters.com/mt/archives/2006/07/label-placement-in-forms.php](http://www.uxmatters.com/mt/archives/2006/07/label-placement-in-forms.php)

19 Miller S, Jarrett C – Should I use a drop-down? Four steps for choosing form elements on the Web **{R41}** : [http://www.formsthatwork.com/files/Articles/dropdown.pdf](http://www.formsthatwork.com/files/Articles/dropdown.pdf)
...
selection list interaction model similar to that of drop-down lists, combo boxes, menus with submenus (see _Windows User Experience Interaction Guidelines_ **{R26}** ) or column views (see _Apple Human Interface Guidelines_ **{R44}** )
...
The use of sections in a selection list and the hiding of options that can be considered to be more ‘advanced’ help to break the information into chunks. The use of ‘chunking’ and the principle of reducing load on short-term and working memory are described in Shneiderman’s _Strategies for effective human-computer interaction_ **{R18}** .

MSP-1940 allows the prioritisation of routes that are normally prescribed whilst still allowing routes not normally associated with the drug to be selected. This meets a requirement (GEN.OS.050) in the _ePrescribing Functional Specification_ **{R12}** to support prescribing drugs using routes that are not normally associated with them. The prioritisation of routes can also be used as part of a mechanism that meets the requirement (GEN.OS.062). The requirement is to be able to prioritise specific routes of administration for patients that have reduced or unusual requirements but to still provide access to other routes (with reminders or alerts).
...
The pre-filling of fields such as administration times (MSP-2020), reflects the GEN.OS.052 requirement in the _ePrescribing Functional_ _Specification_ **{R12}** to provide the ability to define that specific medications should be routinely scheduled for administration at certain times of day and to allow the system to default to these values.
...
**R23.** The Joint Commission – National Patient Safety Goals – NPSG.03.03.01 – Look-alike/soundalike drugs: [http://www.jointcommission.org/AccreditationPrograms/BehavioralHealthCare/Standards/09_FA](http://www.jointcommission.org/AccreditationPrograms/BehavioralHealthCare/Standards/09_FAQs/NPSG/Medication_safety/NPSG.03.03.01/look_alike_sound_alike_drugs.htm) [Qs/NPSG/Medication_safety/NPSG.03.03.01/look_alike_sound_alike_drugs.htm](http://www.jointcommission.org/AccreditationPrograms/BehavioralHealthCare/Standards/09_FAQs/NPSG/Medication_safety/NPSG.03.03.01/look_alike_sound_alike_drugs.htm)

**R24.** NHS CFH – The Use of Tall Man Lettering to Minimise Selection Errors of Medicine Names in Computer Prescribing and Dispensing Systems – Loughborough University Enterprises Ltd: [http://www.connectingforhealth.nhs.uk/systemsandservices/eprescribing/refdocs/tallman.pdf](http://www.connectingforhealth.nhs.uk/systemsandservices/eprescribing/refdocs/tallman.pdf)

**R25.** W3C – Web Content Accessibility Guidelines – W3C Recommendation 5-May-1999: [http://www.w3.org/TR/WAI-WEBCONTENT/](http://www.w3.org/TR/WAI-WEBCONTENT/)

**R26.** Microsoft – Windows User Experience Interaction Guidelines – Guidelines, Controls, Command Buttons: [http://msdn.microsoft.com/en-us/library/aa511453.aspx#defaults](http://msdn.microsoft.com/en-us/library/aa511453.aspx#defaults)
...
See _Designing_ _the User Interface – Strategies for Effective Human-Computer Interaction_ **{R18}** for more information on these principles:
...
See _Ergonomic requirements for office work with visual display terminals (VDTs) – Part 12:_ _Presentation of information_ **{R19}** for more information on these principles:
...
 _Therefore, the drug search prompt should remain even when the field is in focus (if_ _technology allows)_
...
 _If in scope for CUI, consider how this could be made more obvious and what additional_ _actions might be necessary_
...
 _Do not mandate an extra ‘safety-catch’ step without harder evidence to its effectiveness_ _at improving the safety of authorising_
...
 _Discuss prescription status options with the ePrescribing team, and ensure examples_ _given in guidance do not include the potentially ambiguous ‘Started’_
...
 _Explore different positioning of the access to ‘More Options’ to ensure it is considered_ _by prescribers before authorising_

_**Adding a ‘Stat’**_

- All participants were unsure how to ‘add a stat’. Numerous requirements were elicited:

 _Assuming ‘adding a stat’ is out of scope for this CUI release, ensure that example_ _designs are not mistakenly interpreted as providing guidance on adding a stat_
...
 _Does not require the user to choose which template they require UNLESS they are_ _specifying some additional information (for example, a complex schedule)_

 _Does not promote fields that are optional but may mislead the prescriber (for_ _example, presenting an optional strength field before a mandatory dose field)_
...
 _Therefore, there is no user feedback evidence to mandate a particular layout. Though_ _certain ‘good’ layout principles might be described_
...
 _Therefore continue to group fields (on the full form) by ‘field type’ rather than by_ _‘mandatory-ness’_
...
 _Also given the other factors that would influence form layout in a real application (inline_ _error markers, decision support, application conventions on layout, ‘reviewability’ of the_ _resulting prescription, and so on), the CUI should not mandate an exact form layout_
...
 _Therefore, expand options inline, though there may be exceptions when accessing_ _large ‘extra options’ such as administration scheduling. However, it should be_ _considered what happens once optional data has been added_
...
 _There are other factors that would argue against the name redisplay such as the_ _additional space taken up and distraction when comparing different templates_
